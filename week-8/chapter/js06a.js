 ...
 */
  ...
  window.addEventListener("load", function() {
    ...
    // Add an event listener for every form element that supports "change"
    ...
    // Calculate the total cost of the order
      ...
      orderForm.elements.modelNameName.value = model.options[mIndex].text
      let selectedPlan = document.querySelector('input[name="plan"]:checked');
      orderForm.elements.planNameName.value = selectedPlan.labels[0].textContent;
  }
});
