...
// Run createLightbox function when the page fully loads
window.addEventListener("load", createLightbox);

// Function to create the lightbox container and its parts
function createLightbox() {
    ...
    if (timeID) {
        ...
        // Start the slideshow
        showNext();  // Show next image immediately
        timeID = window.setInterval(showNext, 1500);  // Then advance every 1.5 seconds
    }
}
    ...
    // Create the overlay container for the lightbox
